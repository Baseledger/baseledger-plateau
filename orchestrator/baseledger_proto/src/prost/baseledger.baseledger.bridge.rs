...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryValidatorAddressByOrchestratorAddressRequest {
    #[prost(string, tag="1")]
    pub orchestrator_address: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct QueryValidatorAddressByOrchestratorAddressResponse {
    #[prost(string, tag="1")]
    pub validator_address: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateOrchestratorValidatorAddress {
    #[prost(string, tag="1")]
    pub validator_address: ::prost::alloc::string::String,
    #[prost(string, tag="2")]
    pub orchestrator_address: ::prost::alloc::string::String,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgUpdateOrchestratorValidatorAddressResponse {
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct MsgDeleteOrchestratorValidatorAddress {
    #[prost(string, tag="1")]
    pub validator_address: ::prost::alloc::string::String,
    #[prost(string, tag="2")]
    pub orchestrator_address: ::prost::alloc::string::String,
...
pub struct GenesisState {
    ...
    pub orchestrator_addresses: ::prost::alloc::vec::Vec<MsgSetOrchestratorAddress>,
    #[prost(uint64, tag="4")]
