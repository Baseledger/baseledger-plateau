...
import (
	...
	baseledgerbridgesimulation "github.com/Baseledger/baseledger-bridge/x/bridge/simulation"
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		baseledgerbridgesimulation.SimulateMsgSetOrchestratorAddress(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		baseledgerbridgesimulation.SimulateMsgValidatorPowerChangedClaim(am.accountKeeper, am.bankKeeper, am.keeper),
	))
