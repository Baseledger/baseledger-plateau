...
func init() {
	proto.RegisterType((*MsgUbtDepositedClaim)(nil), "Baseledger.baseledgerbridge.bridge.MsgUbtDepositedClaim")
	proto.RegisterType((*MsgUbtDepositedClaimResponse)(nil), "Baseledger.baseledgerbridge.bridge.MsgUbtDepositedClaimResponse")
	proto.RegisterType((*MsgSetOrchestratorAddress)(nil), "Baseledger.baseledgerbridge.bridge.MsgSetOrchestratorAddress")
	proto.RegisterType((*MsgSetOrchestratorAddressResponse)(nil), "Baseledger.baseledgerbridge.bridge.MsgSetOrchestratorAddressResponse")
	proto.RegisterType((*MsgValidatorPowerChangedClaim)(nil), "Baseledger.baseledgerbridge.bridge.MsgValidatorPowerChangedClaim")
	proto.RegisterType((*MsgValidatorPowerChangedClaimResponse)(nil), "Baseledger.baseledgerbridge.bridge.MsgValidatorPowerChangedClaimResponse")
}
...
func (c *msgClient) UbtDepositedClaim(ctx context.Context, in *MsgUbtDepositedClaim, opts ...grpc.CallOption) (*MsgUbtDepositedClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Baseledger.baseledgerbridge.bridge.Msg/UbtDepositedClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetOrchestratorAddress(ctx context.Context, in *MsgSetOrchestratorAddress, opts ...grpc.CallOption) (*MsgSetOrchestratorAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Baseledger.baseledgerbridge.bridge.Msg/SetOrchestratorAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ValidatorPowerChangedClaim(ctx context.Context, in *MsgValidatorPowerChangedClaim, opts ...grpc.CallOption) (*MsgValidatorPowerChangedClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Baseledger.baseledgerbridge.bridge.Msg/ValidatorPowerChangedClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UbtDepositedClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Baseledger.baseledgerbridge.bridge.Msg/UbtDepositedClaim",
	}
...
func _Msg_SetOrchestratorAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Baseledger.baseledgerbridge.bridge.Msg/SetOrchestratorAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_ValidatorPowerChangedClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Baseledger.baseledgerbridge.bridge.Msg/ValidatorPowerChangedClaim",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "Baseledger.baseledgerbridge.bridge.Msg",
