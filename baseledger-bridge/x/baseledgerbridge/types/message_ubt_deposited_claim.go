...
func NewMsgUbtDepositedClaim(creator string, eventNonce string, blockHeight string, tokenContract string, amount string, ethereumSender string, cosmosReceiver string) *MsgUbtDepositedClaim {
